...
function title() {
      console.clear()
	  console.log(chalk.bold.green(figlet.textSync('Vlynn - Md', {
		font: 'Standard',
	...
	console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Created By Vlynn ]')}\n\n${chalk.red('Chitanda Eru Bot')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@fikenzyy')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+62 813-6897-1807')}\n${chalk.red('Donate')} : ${chalk.white('081368978107 ( Gopay/Pulsa )')}\n`))
}
...
const connectToWhatsApp = async () => {
	const conn = makeWASocket({
            ...
            browser: ["Vlynn Multi Device", "Safari", "3.0"]
        })
	title()
