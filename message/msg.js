   ...
   conn.sendMessage(from, { audio: {url : `https://d.top4top.io/m_22231oj7h1.mp3`}, mimetype: 'audio/mp4', ptt: true}, {quoted: msg})
		...
		switch(command) {
			...
			case prefix+'help':
			    ...
			    conn.sendMessage(from, { caption: teks, location: { jpegThumbnail: fs.readFileSync(setting.pathimg) }, templateButtons: buttonsDefault, footer: '© Vlynn', mentions: [sender] })
				break
...
var teks = `  │
  ...
  ├─ ❏ 081368971807
  ├─ ❏ INSTAGRAM
  └─ ❏ https://www.instagram.com/fikenzyy
  
  Donasi Untuk Upgrade Ke Fitur Premium
  Note : Donasi Seikhlasnya`
 conn.sendMessage(from, { caption: teks, image: {url: `https://i.ibb.co/CPcFJ6c/IMG-20220131-WA0504.jpg`}, templateButtons: donasibut, footer: '© Vlynn - Md', mentions: [sender]} )  
			    break
case prefix+'sewa':
  case prefix+'daftarprem':
  var teks = `*[ LIST HARGA VLYNN PREM ]*
...
- Rp.20.000 - Lima Bulan`
			    conn.sendMessage(from, { caption: teks, location: { jpegThumbnail: fs.readFileSync(setting.pathimg) }, templateButtons: button5, footer: '© Vlynn - Md', mentions: [sender] })
			    break
			case prefix+'runtime':
			    reply(runtime(process.uptime()))
			    break
case prefix+'groupjojo':
  reply("Group 1\n\nhttps://chat.whatsapp.com/GvFdwRZnQdGGZcQ92OZekq")
  break
			case prefix+'speed':
			    let timestamp = speed();
...
conn.sendMessage(from, { text: anjayani, buttons: but, footer: "© Vlynn - Md", templateButtons: but }, {quoted: msg})
				limitAdd(sender, limit)
				break
...
conn.sendMessage(from, { text: caption, buttons: but, footer: "© Vlynn - Md", templateButtons: but }, {quoted: msg})
limitAdd(sender, limit)
break
//maker arasya
case prefix+'leaves':
